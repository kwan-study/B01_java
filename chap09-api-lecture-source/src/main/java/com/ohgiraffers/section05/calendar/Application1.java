...
public class Application1 {
    public static void main(String[] args) {
        ...
        java.util.Date today = new java.util.Date();        // 시스템의 현재 시간을 가진 객체
        System.out.println("today = " + today);

        System.out.println("long 타입 시간: " + today.getTime()); // KST로 1970년 1월 1일 오전 9시 이후 흐른 milliseconds
        ...
        String todayFormat = sdf.format(today);         // 매개변수로 Date 형을 필요로 함
